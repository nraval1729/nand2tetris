...
set instruction %B0011000000111001, // @12345, A=12345
tick, output, tock, output;

set instruction %B1110110000010000, // D=A, D=12345
tick, output, tock, output;

set instruction %B0101101110100000, // @23456, A=23456
tick, output, tock, output;

set instruction %B1110000111010000, // D=A-D, D=11111
tick, output, tock, output;

set instruction %B0000001111101000, // @1000, A=1000
tick, output, tock, output;

set instruction %B1110001100001000, // M=D, RAM[1000]=11111
tick, output, tock, output;

set instruction %B0000001111101001, // @1001, A=1001
tick, output, tock, output;

set instruction %B1110001110011000, // MD=D-1, RAM[1001]=11110, D=11110
tick, output, tock, output;

set instruction %B0000001111101000, // @1000, A=1000
tick, output, tock, output;

set instruction %B1111010011010000, // D=D-M, D=11110-11111=-1
set inM 11111,
tick, output, tock, output;

set instruction %B0000000000001110, // @14, A=14
tick, output, tock, output;
